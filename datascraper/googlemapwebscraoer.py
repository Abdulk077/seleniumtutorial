...
# Selenium Webdriver
os.environ['PATH'] += r":\Program Files (x86)\chrome-win64"
...
time.sleep(5)
result = driver.find_element(By.XPATH, '/html/body/div[3]/div[9]/div[8]/div/div[1]/div/div/div[2]/div[1]/div[13]/div/a ')
...
result1 = driver.find_element(By.XPATH,'/html/body/div[3]/div[9]/div[8]/div/div[1]/div/div/div[2]/div[1]/div[27]/div/a')
driver.execute_script("arguments[0].scrollIntoView();", result1)
print(driver.title)
print(result1)

result2 = driver.find_element(By.XPATH, '/html/body/div[3]/div[9]/div[8]/div/div[1]/div/div/div[2]/div[1]/div[39]/div/a')
...
time.sleep(4)
entries = driver.find_element(By.CLASS_NAME, 'a4gq8e-aVTXAb-haAclf-jRmmHf-hSRGPd')
scroll = driver.find_element(By.CSS_SELECTOR ,'div[class="siAUzd-neVct section-scrollbox"]')
...
def phone_website(text1):
    ...
    company_name = driver.find_elemen(By.XPATH, '//*[@id="pane"]/div/div[1]/div/div/div[2]/div[1]/div[1]/div[1]/h1/span[1]').text

    try:
        address = driver.find_element(By.XPATH, '//*[@id="pane"]/div/div[1]/div/div/div[7]/div[1]/button/div[1]/div[2]/div[1]').text
